import { listLateRegularizationsService, reviewLateRegularizationService, submitLateRegularizationService, } from "../../services/attendance/late-regularization.service.js";
...
export const reviewLateRegularization = async (req, res, next) => {
    try {
        const data = await reviewLateRegularizationService(req.user.id, req.params.id, req.body);
...
//# sourceMappingURL=late-regularization.controller.js.map