import { createShiftService, getShiftsService, getShiftByIdService, updateShiftService, toggleShiftStatusService, deleteShiftService, } from "../../services/attendance/shift.service.js";
...
export const toggleShiftStatus = async (req, res, next) => {
    try {
        ...
        send(res, 200, req.body.is_active ? "Shift activated successfully" : "Shift deactivated successfully", data);
    }
    catch (err) {
        next(err);
    }
