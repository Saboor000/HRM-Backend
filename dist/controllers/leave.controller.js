import { cancelLeaveService, createLeaveService, getLeaveByIdService, getLeavesService, hrLeaveActionService, managerLeaveActionService, } from "../services/leave.service.js";
...
export const managerLeaveAction = withErrorHandling(async (req, res) => {
    const leave = await managerLeaveActionService(req.params.id, req.body.action, req.user, req.body.rejection_reason);
...
export const hrLeaveAction = withErrorHandling(async (req, res) => {
    const leave = await hrLeaveActionService(req.params.id, req.body.action, req.user, req.body.rejection_reason);
