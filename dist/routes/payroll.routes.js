...
payrollRouter.post("/salary-structures", adminHr, validateBody(salaryStructureCreateSchema), createSalaryStructure);
payrollRouter.get("/salary-structures", adminHr, validateQuery(salaryStructureListQuerySchema), getSalaryStructures);
payrollRouter.get("/salary-structures/employee/:employee_id", adminHrEmployee, validateParams(salaryStructureEmployeeParamSchema), getSalaryStructureByEmployee);
payrollRouter.get("/salary-structures/:id", adminHr, validateParams(salaryStructureIdParamSchema), getSalaryStructureById);
...
payrollRouter.post("/payroll/:id/mark-paid", adminHr, validatePayrollId, markPayrollPaid);
payrollRouter.get("/payslip/:id", adminHrEmployee, validatePayrollId, getPayslip);
