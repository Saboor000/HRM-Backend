...
const withDateRangeValidation = (schema) => schema.custom((value, helpers) => {
...
export const dashboardOverviewQuerySchema = withDateRangeValidation(strictObject({
    ...dashboardQueryBase,
}));
export const dashboardAttendanceAnalyticsQuerySchema = withDateRangeValidation(strictObject({
    ...dashboardQueryBase,
