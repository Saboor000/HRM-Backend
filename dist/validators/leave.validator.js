import Joi from "joi";
import { hasInvalidTimeRange, isEndDateBeforeStart, isoDateRule, limitRule, pageRule, sortOrderRule, strictObject, timeHHmmRule, uuidRule, } from "./common.validator.js";
...
const normalizeSingleDayFields = (value) => {
    ...
    if (!singleDayTypes.has(value.leave_type) || !normalizedLeaveDate)
        return;
...
//# sourceMappingURL=leave.validator.js.map