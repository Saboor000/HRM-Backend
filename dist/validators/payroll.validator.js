...
const componentCollectionRule = Joi.alternatives().try(Joi.array().items(salaryComponentSchema), Joi.object().unknown(true), amountRule);
export const salaryStructureCreateSchema = strictObject({
    ...
    overtime_policy_id: uuidRule.optional(),
    tax_policy_id: uuidRule.optional(),
