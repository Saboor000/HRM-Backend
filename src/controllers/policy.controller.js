...
export const createAttendancePolicy = createPolicyController(
  PolicyService.createAttendancePolicy,
  'Attendance policy created successfully'
);
export const updateAttendancePolicy = updatePolicyController(
  PolicyService.updateAttendancePolicy,
...
export const createOvertimePolicy = createPolicyController(
  PolicyService.createOvertimePolicy,
...
export const createTaxPolicy = createPolicyController(
  PolicyService.createTaxPolicy,
  'Tax policy created successfully'
);
...
export const createBonusPolicy = createPolicyController(
  PolicyService.createBonusPolicy,
  'Bonus policy created successfully'
);
